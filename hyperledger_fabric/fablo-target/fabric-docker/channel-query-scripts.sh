...
channelQuery() {
  ...
  then
    ...
    [ "$1" = "list" ] && [ "$2" = "org1" ] && [ "$3" = "peer2" ]
  then

    peerChannelListTls "cli.org1.example.com" "peer2.org1.example.com:7043" "crypto-orderer/tlsca.orderer.example.com-cert.pem"
...
printChannelsHelp() {
  ...
  echo "fablo channel list org1 peer2"
  echo -e "\t List channels on 'peer2' of 'Org1'".
  echo ""
